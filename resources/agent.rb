...
property :go_server_host, :kind_of => String, :required => false, :default => nil
property :go_server_port, :kind_of => Integer, :required => false, :default => node['gocd']['agent']['go_server_port']
